...
namespace SalonGarden.Web.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Evaluations_Techniques_TechniqueId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Warm Welcome", 1, 1, 0 },
                    { 21, "Teach Guest How to Recreate", 5, 4, 0 },
                    { 20, "Control of Hair", 5, 3, 0 },
                    { 19, "Sectioning", 5, 2, 0 },
                    { 18, "Explanation of Products", 5, 1, 0 },
                    { 16, "Personal Appearance", 4, 2, 0 },
                    { 15, "Appropriate Conversation", 4, 1, 0 },
                    { 14, "Completed On Time", 3, 7, 0 },
                    { 13, "Cross Check/Balance", 3, 6, 0 },
                    { 12, "Control", 3, 5, 0 },
                    { 17, "Ask for Referrals/Rebooks", 4, 3, 0 },
                    { 10, "Body Position", 3, 3, 0 },
                    { 9, "Clean Sections", 3, 2, 0 },
                    { 8, "Shampoo/Massage/Cleanup", 3, 1, 0 },
                    { 7, "Review/Agreement", 2, 5, 0 },
                    { 6, "Maintenance/Product Reccomendations", 2, 4, 0 },
                    { 5, "Appropriate Questions", 2, 3, 0 },
                    { 4, "Listening Skills", 2, 2, 0 },
                    { 3, "Sensory Experience", 2, 1, 0 },
                    { 2, "Introduction", 1, 2, 0 },
                    { 11, "Knowledge of Technique", 3, 4, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, "Short Graduation", 2 },
                    { 9, "Triangular graduation", 2 },
                    { 8, "Vertical Graduation", 2 },
                    { 7, "Horizontal Graduation", 2 },
                    { 6, "Clipper Cut", 2 },
                    { 1, "Vertical Foil", 1 },
                    { 4, "Single Process", 1 },
                    { 3, "Double Process", 1 },
                    { 2, "Diagonal Foil", 1 },
                    { 11, "Short Round Layer", 2 },
                    { 5, "Scissor Over Comb", 2 },
                    { 12, "Long Layer", 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_TechniqueId",
                table: "Evaluations",
                column: "TechniqueId");
